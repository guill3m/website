...
date:
  ...
  year: 2010
featured: false
thumbnail: './assets/la-fille-du-regiment-thumbnail.png'
---

import { Picture } from 'astro:assets'
import image1 from './assets/la-fille-du-regiment-1.jpg'
...
<Picture
  ...
  loading="eager"
  sizes={[
    '(min-width: 100em) 930px',
    '(min-width: 72em) calc((100vw - 3rlh) / 13 * 8)',
    '(min-width: 52em) calc((100vw - 3rlh) / 13 * 11)',
    'calc(100vw - 3rlh)',
  ].join()}
  src={image1}
  width={930}
  widths={[680, 780, 930, 1050, 1300, 1520, 1750, image1.width]}
/>
