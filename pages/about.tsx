...
export default function AboutPage () {
  return (
    <>
      <Meta
        title='About me - Guillem Andreu'
        description='Hi, my name is Guillem and I’m a graphic designer from València (ES), currently living in Berlin (DE). I’m also a self-taught front-end web developer.'
      />
